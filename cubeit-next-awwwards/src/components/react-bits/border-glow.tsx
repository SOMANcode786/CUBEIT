...
import { useRef, useCallback, useState, useEffect, type ReactNode, type PointerEvent } from 'react';
...
function animateValue({ start = 0, end = 100, duration = 1000, delay = 0, ease = easeOutCubic, onUpdate, onEnd }: AnimateValueArgs) {
